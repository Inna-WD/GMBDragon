...
const serviceSEO = () => {
  ...
  <section class="hero">
    <div class="program-banner-8">
      <h1 class="hero-text">Website Keyword Research and SEO Services</h1> <br>
    </div>
  </section>
  ...
  <div><a href="/serviceSeo" data-route="/serviceSeo"><h1 class="program-button">KEYWORD RESEARCH and SEO</h1></a></div>
    ...
    <section class="program-home">
      <article>
            <h2 class="main-text">What are Website Keyword Research and SEO services ?</h2>
              <p>
                    some content
              </p>
